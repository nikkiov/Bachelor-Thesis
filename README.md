...
# Significance.R: A script that compares predictors between outcome groups and performs statistical tests to assess those differences.
...
# Visualisation_OneFile.R: Does what SummaryRawData.R and CircadianFeatureExtraction.R do, but also plots actigraphy data throughout the script and compares several participants/groups to eachother.
